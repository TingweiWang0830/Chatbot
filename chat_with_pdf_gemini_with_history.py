...
GOOGLE_API_KEY = 'AIzaSyDZlI6V4IAXqKQpCYasfHmYvMurafeO0kU' # "YOUR_GOOGLE_API_KEY"  # Replace with your actual Gemini API key
...
if uploaded_files:
    ...
    if user_input:
        ...
        retriever = st.session_state.vector_store.as_retriever(
            ...
            search_kwargs={"k": 8, "fetch_k": 40, "lambda_mult": 0.9}  # Adjust these parameters as needed
        )
